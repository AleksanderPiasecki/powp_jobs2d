...
public class LineDrawerAdapter implements Job2dDriver {
    ...
    private LineMode lineMode = LineMode.BASIC;
    ...
    public void operateTo(int x, int y) {
        ...
        switch (this.lineMode) {
            ...
            case SPECIAL:
                ...
                break;
            default:
                throw new IllegalArgumentException("Unsupported line mode: " + this.lineMode.toString());
        };
	...
	public String toString() {
		return "Line mode: " + this.lineMode.toString();
	}
